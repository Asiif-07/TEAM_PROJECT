    ...
    <footer className="bg-slate-800 text-gray-300 py-12 px-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center mb-6">
              <div className="flex -space-x-2">
                <img src="https://i.pravatar.cc/40?img=1" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
                <img src="https://i.pravatar.cc/40?img=2" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
                <img src="https://i.pravatar.cc/40?img=3" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
                <img src="https://i.pravatar.cc/40?img=4" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
                <img src="https://i.pravatar.cc/40?img=5" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
                <img src="https://i.pravatar.cc/40?img=6" alt="User" className="w-10 h-10 rounded-full border-2 border-slate-800" />
              </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="flex flex-col sm:flex-row items-center gap-6 text-sm">
              ...
              <div className="flex items-center gap-2">
                <PhoneIcon />
                <a href="tel:+442079460958" className="text-gray-400 hover:text-white transition-colors">
                  +44 20 7946 0958
                </a>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="hidden lg:block mt-4">
          <nav>
            <ul className="flex justify-end gap-6 text-sm">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Privacy Policy</a>
              </li>
              <li>
