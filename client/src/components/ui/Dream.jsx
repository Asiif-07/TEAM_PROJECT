    ...
    >
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 mb-12">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#667085] text-sm font-medium">{t("24-48 Delivery")}</span>
        </div>

        <div className="flex items-center gap-2">
          <img src={shield} alt="Shield" className="w-5 h-5 object-contain" />
          <span className="text-[#667085] text-sm font-medium">{t("Money-back Guarantee")}</span>
        </div>

        <div className="flex items-center gap-2">
          <img src={vector} alt="Vector" className="w-5 h-5 object-contain" />
          <span className="text-[#667085] text-sm font-medium">{t("Unlimited Revisions")}</span>
        </div>
      </div>
