...
const RibbonHeader = ({ title, color = "#222" }) => (
...
// Main Content Header
const MainHeader = ({ title, color = "#222" }) => (
    <Typography variant="h5" sx={{ fontWeight: 900, color: color, mb: 3, letterSpacing: "0.5px" }}>
        {title}
    </Typography>
);

export default function ModernTemplate({ data, accentColor = "#222" }) {
    ...
    return (
        <Box className="cv-document" sx={{
            ...
            <Box sx={{ width: "35%", bgcolor: "#EAEAEA", pb: 5, position: "relative", zIndex: 1 }}>
                ...
                <RibbonHeader title="Contact" color={accentColor} />
                ...
                {safeEducation.length > 0 && (
                    <>
                        <RibbonHeader title="Education" color={accentColor} />
                ...
                {safeSkills.length > 0 && (
                    <>
                        <RibbonHeader title="Skills" color={accentColor} />
                ...
                {safeLanguages.length > 0 && (
                    <>
                        <RibbonHeader title="Language" color={accentColor} />
                        <Box component="ul" sx={{ m: 0, pl: 7, pr: 2 }}>
            ...
            <Box sx={{ width: "65%", p: "50px 40px", position: "relative" }}>
                ...
                {(personalInfo.about || personalInfo.summary) && (
                    <Box sx={{ mb: 4, position: "relative", zIndex: 2 }}>
                        <Typography variant="body2" sx={{ color: "#333", lineHeight: 1.7, fontSize: "0.9rem", textAlign: "justify", whiteSpace: "pre-wrap" }}>
                ...
                {safeExperience.length > 0 && (
                    <Box sx={{ mb: 4 }}>
                        <MainHeader title="Professional Experience" color={accentColor} />
                ...
                {safeReferences.length > 0 && (
                    <Box sx={{ mt: 5 }}>
                        <MainHeader title="References" color={accentColor} />
